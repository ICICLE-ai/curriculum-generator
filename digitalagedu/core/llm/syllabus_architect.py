...
def formulate_syllabus(
    ...
    prompt = (
        ...
        f"   - Intermediate Weeks: Machine learning concepts. Take each module as a natural next step from the module beforehand\n"
        f"   - Late Weeks: XAI/Explainability (Model Debugging / Where the AI looks) & Error Analysis\n"
